...
-- 6. Correctif v30 - droits Supabase Auth pour les profils
-- Corrige l'erreur: permission denied for table profiles.
grant usage on schema public to anon, authenticated;
grant select, insert, update on public.profiles to authenticated;
grant select, insert, update, delete on public.competitions to authenticated;
grant select, insert, update, delete on public.competition_members to authenticated;
...
grant select, insert, update, delete on public.card_signatures to authenticated;
grant select, insert, update, delete on public.competition_invitations to authenticated;
